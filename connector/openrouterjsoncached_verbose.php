...
class openrouterjsoncached_verbose
{
    ...
    const VERSION = 'OpenRouter Cache Connector v1.0.17 for CHIM 2.0.3 | 2025/11/10 (VERBOSE)';
        ...
        if ($this->_responseFormat === 'json') {
            ...
            if (!$this->_simpleFormatParsed) {
                ...
                if ($parsed['found']) {
                    ...
                    // VERBOSE_LOGGING_START - Simple format parse failure
                    if ($this->_verboseLogging) {
                        logMessage("[CACHE-VERBOSE] Simple format regex did not match. Full buffer: " . $this->_buffer);
                    }
                    // VERBOSE_LOGGING_END
