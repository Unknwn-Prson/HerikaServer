...
class openrouterjsoncached_verbose
{
    ...
    const VERSION = 'OpenRouter Cache Connector v1.1.4 for CHIM 2.0.3 | 2025/11/12 (VERBOSE)';
        ...
        if ($this->_responseFormat === 'json') {
            ...
            if (!$this->_simpleFormatParsed) {
                ...
                if ($parsed['found']) {
                    ...
                    // VERBOSE_LOGGING_START - _parseAndReturnContent: Simple format fallback
                    if ($this->_verboseLogging) {
                        logMessage("[CACHE-VERBOSE] ⚠️ FALLBACK ACTIVATED - Returning entire buffer as message");
                        logMessage("[CACHE-VERBOSE] Buffer length: " . strlen($this->_buffer));
                        ...
                        logMessage("[CACHE-VERBOSE] Full buffer: " . $this->_buffer);
