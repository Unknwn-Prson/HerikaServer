...
/*
 * ============================================================================
 * PARAMETER PRECISION BACKUP FILE - DO NOT USE IN PRODUCTION
 * ============================================================================
 *
 * This is a backup copy of llm_connectors.php created to preserve parameter
 * precision settings (temperature, penalties, top_p, etc.) for reference.
 *
 * IMPORTANT NOTES:
 * - This file should be updated whenever the original llm_connectors.php
 *   is updated to keep it in sync
 * - This file MUST be deleted before sending code to production
 * - Claude (AI assistant) should NOT delete this file - only humans should
 * - This file exists purely for reference and backup purposes
 *
 * Parameter precision settings are located at:
 * - Line ~495-504 (embedded editor)
 * - Line ~1561-1570 (modal editor)
 *
 * Current precision: step=>0.01 (2 decimal places)
 * To change: Modify step value (e.g., 0.001 for 3 decimals, 0.0001 for 4)
 * ============================================================================
 */
$enginePath = __DIR__ . "/../../";
